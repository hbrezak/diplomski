...
% Nstep=10000;
% DelT = TTT/Nstep;
% [t, x] = rk4(@EquatsPend, tspan, xinit, DelT);
% %------------------------------------------------------


function [tout, yout] = rk4(FunFcn, tspan, y0, ssize)

% I downloaded this from "John C. Polking" <polking@math.rice.edu> on 12
% February 1999. Other than this
% comment I made no changes to the program. It is an alternative to the
% built-in Matlab ode differential equation
% solvers that lets one specify the step size. JSL
